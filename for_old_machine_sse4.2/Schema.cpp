...
inline void map_candidate_votes_mutiple_cut_end_to_end_2(
...
inline void map_candidate_votes_mutiple_cut_end_to_end_2_for_paired_end(
	seed_votes* candidate_votes, bitmapper_bs_iter* candidate_votes_length,
	bitmapper_bs_iter read_length, bitmapper_bs_iter error_threshold,
	char* tmp_ref, char* read, __m128i* Peq_SSE, unsigned int* min_err, int* best_mapping_occ,
	char* name)
...
inline int map_candidate_votes_mutiple_end_to_end_2(
	seed_votes* candidate_votes, bitmapper_bs_iter* candidate_votes_length,
	bitmapper_bs_iter read_length, bitmapper_bs_iter error_threshold,
	char* tmp_ref, char* read, __m128i* Peq_SSE, unsigned int* min_err, int* min_err_index)
{
	...
	bitmapper_bs_iter* full_seed_id1)
{
	...
	**/
	...
	else if (candidate_length1 != 0)
	{
		...
		{
			map_candidate_votes_mutiple_cut_end_to_end_2_for_paired_end(candidates_votes1, &candidates_votes_length1, (*current_read).length,
				error_threshold, tmp_ref, (*current_read).seq, Peq_SSE, &min_err, &best_mapp_occ1, (*current_read).name);
		}
	...
	__m128i* Peq_SSE)
{
	...
	{
		map_candidate_votes_mutiple_cut_end_to_end_2_for_paired_end(candidates_votes, &candidates_votes_length, (*current_read).length,
			error_threshold, tmp_ref, (*current_read).seq, Peq_SSE, &min_err, &best_mapp_occ, (*current_read).name);
	}
			...
			if (is_mutiple_map == 0)
			{
				...
				else
				{
					...
					**/
					...
					map_candidate_votes_mutiple_cut_end_to_end_2(candidates_votes, &candidates_votes_length, current_read.length,
						error_threshold1, tmp_ref, current_read.seq, Peq_SSE, &min_err, &min_err_index);
				}
			...
			else
			{
				...
				else
				{
					...
					**/
					...
					map_candidate_votes_mutiple_end_to_end_2(candidates_votes, &candidates_votes_length, current_read.length,
						error_threshold1, tmp_ref, current_read.seq, Peq_SSE, &min_err, &min_err_index);
				}
		...
		while (i < obtain_reads_num)
		{
			...
			else if (candidate_length != 0)
			{
				...
				if (is_mutiple_map == 0)
				{
					...
					{
						map_candidate_votes_mutiple_cut_end_to_end_2(candidates_votes, &candidates_votes_length, read_batch[i].length,
							error_threshold1, tmp_ref, read_batch[i].seq, Peq_SSE, &min_err, &min_err_index);
					}
				...
				else
				{
					...
					{
						map_candidate_votes_mutiple_end_to_end_2(candidates_votes, &candidates_votes_length, read_batch[i].length,
							error_threshold1, tmp_ref, read_batch[i].seq, Peq_SSE, &min_err, &min_err_index);
					}
